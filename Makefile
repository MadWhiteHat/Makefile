...
--freetype: --zlib ${FREETYPE_SOURCE_DIR}
...
static: BUILD_DIR=${PROJECT_BUILD_DIR}/${STATIC}
static: ZLIB_BINARY_DIR=${BUILD_DIR}/${ZLIB_DIR}
static: ZLIB_TARGET=zlibstatic
static: ZLIB_FLAGS="${CC_FLAGS}"
static: ZLIB_STATIC_LIB=${ZLIB_BINARY_DIR}/${ZLIB_STATIC_LIB_NAME}
static: LIBPNG_BINARY_DIR=${BUILD_DIR}/${LIBPNG_DIR}
static: LIBPNG_BUILD_STATIC=ON
static: LIBPNG_BUILD_SHARED=OFF
static: LIBPNG_TARGET=png_static
static: LIBPNG_FLAGS="${CC_FLAGS}"
static: LIBPNG_STATIC_LIB=${LIBPNG_BINARY_DIR}/${LIBPNG_STATIC_LIB_NAME}
static: FREETYPE_BINARY_DIR=${BUILD_DIR}/${FREETYPE_DIR}
static: FREETYPE_BUILD_SHARED_LIBS=OFF
static: FREETYPE_TARGET=freetype
static: FREETYPE_STATIC_LIB=${FREETYPE_BINARY_DIR}/${FREETYPE_STATIC_LIB_NAME}
static: FREETYPE_FLAGS="${CC_FLAGS}"
static: PROJECT_LINKAGE_TYPE=STATIC
static: PROJECT_BINARY_DIR=${BUILD_DIR}/${PROJECT_NAME}
static: PROJECT_EXECUTABLE_NAME=${PROJECT_NAME}-${STATIC}.out
static: --libs \
